...
export DATABASE_URL=`heroku config:get DATABASE_URL --app edfpocsynchrokafka`
export KAFKA_CLIENT_CERT=`heroku config:get KAFKA_CLIENT_CERT  --app edfpocsynchrokafka`
export KAFKA_CLIENT_CERT_KEY=`heroku config:get KAFKA_CLIENT_CERT_KEY  --app edfpocsynchrokafka`
export KAFKA_PREFIX=`heroku config:get KAFKA_PREFIX  --app edfpocsynchrokafka`
export KAFKA_TRUSTED_CERT=`heroku config:get KAFKA_TRUSTED_CERT  --app edfpocsynchrokafka`
export KAFKA_URL=`heroku config:get KAFKA_URL  --app edfpocsynchrokafka`
...
export REDIS_URL=`heroku config:get REDIS_URL --app edfpocsynchrokafka`
