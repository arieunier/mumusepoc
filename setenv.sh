...
export KAFKA_CLIENT_CERT=`heroku config:get KAFKA_CLIENT_CERT  --app edfpocsynchrodata`
export KAFKA_CLIENT_CERT_KEY=`heroku config:get KAFKA_CLIENT_CERT_KEY  --app edfpocsynchrodata`
export KAFKA_PREFIX=`heroku config:get KAFKA_PREFIX  --app edfpocsynchrodata`
export KAFKA_TRUSTED_CERT=`heroku config:get KAFKA_TRUSTED_CERT  --app edfpocsynchrodata`
export KAFKA_URL=`heroku config:get KAFKA_URL  --app edfpocsynchrodata`
...
export REDIS_URL=`heroku config:get REDIS_URL --app edfpocsynchrodata`
